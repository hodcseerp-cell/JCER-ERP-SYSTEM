                ...
                years.map((yr) => (
                  <tr key={yr.id} className="hover:bg-neutral-50/60 dark:hover:bg-neutral-800/30 transition-colors">
                    ...
                    <td className="py-4 px-6 text-center">
                      {yr.isCurrent ? (
                        <span className="inline-flex items-center space-x-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-amber-500/15 text-amber-700 dark:text-amber-300">
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <div className="flex items-center space-x-2 pt-1">
                ...
                <label htmlFor="isCurrentYear" className="text-xs font-semibold text-neutral-800 dark:text-neutral-200">
                  Set as Current Institutional Active Session
                </label>
              </div>
